<%-- 
    Document   : about
    Created on : 16 Jan 2026, 9:33:00 am
    Author     : Damia
--%>
        ...
        <div class="page">
            ...
            <div class="sidebar">
                ...
                <div class="menu">
                    ...
                    <!-- Use servlet for books, same as other pages -->
                    <a href="<%=ctx%>/BooksServlet"><span>📖</span> Books</a>
                    <a class="active" href="<%=ctx%>/about.jsp"><span>ℹ️</span> About</a>
                    ...
                    <% } else { %>
                        ...
                        <% } %>
                        <!-- show order history only when logged in -->
                ...
                <div class="center-col">
                    ...
                    <div class="content-card">
                        ...
                        <div class="cta">
                            ...
                            <div class="btn-row">
                                <form action="<%=ctx%>/BooksServlet" method="get">
